                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <input type="text" class="form-control" name="name" value="{prog_name}" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Program Id <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" value="{prog_id}" name="id" required>
                                            </div>
                                        </div>
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                <label>Program Capacity <span class="login-danger">*</span></label>
                                                <input type="text" class="form-control" value="{capacity}" name="capacity" required>
                                            </div>
                                        </div>
                                         <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <select class="form-control select"  name="nta" id="nta">
                                                    <option value="{nta_old}">{nta_old_label}</option>
                                        ...
                                        <div class="col-12 col-sm-4">
                                            <div class="form-group local-forms">
                                                ...
                                                <option value="{dept_old}">{dept_old}</option>
                                        ...
                                        <div class="col-12">
                                            <div class="student-submit">
                                                <a href="{$url}program" class="btn btn-warning">{btn-back}</a>
                                                <button type="submit" class="btn btn-primary">{btn-name}</button>
                                            </div>
                                        </div>
                                    </div>
                                </form>
